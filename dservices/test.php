            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">                                
                                <a class="btn btn-success form-control" href={{ url('register') }}>
                                    Nuevo usuario
                                </a>
                            </div>
                        </div>
...
- agregar composer
- instalar composer intall
- Config - app.php -> Agregar los providers y los alias (buscar de forma independiente), Agregar clases de aliases
- 